...
export const getStaticPaths: GetStaticPaths = async () => {
    try {
        const res = await fetch("https://server-json-one.vercel.app/services");
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    const res = await fetch(`https://server-json-one.vercel.app/services/${params.slug}`);
    const serviceData: ServicesProps = await res.json();

    const resGallery = await fetch(`https://server-json-one.vercel.app/services_gallery`);
