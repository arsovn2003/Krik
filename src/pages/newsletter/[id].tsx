...
export async function getServerSideProps(context: any) {
    ...
    const newsletterRes = await fetch(`https://json-server-for-krik.onrender.com/newsletter/${id}`);
    ...
    const datesRes2 = await fetch("https://json-server-for-krik.onrender.com/newsletter_news");
